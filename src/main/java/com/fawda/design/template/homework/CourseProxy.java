...
public class CourseProxy {
    ...
    private boolean needChekhomeWork;

    public CourseProxy(ICourse course) {
        this.course = course;
    }

    public void setNeedChekhomeWork(boolean needChekhomeWork) {
        this.needChekhomeWork = needChekhomeWork;
    }
    ...
    protected final void ceateCourse() {
        ...
        if (needChekhomeWork()) {
            course.checkHomeWork();
        }
    }

    private boolean needChekhomeWork() {
        return this.needChekhomeWork;
    }
    ...
    private void postReoure(){
        System.out.println("制作课件");
    };

    private void liveVdeo(){
        System.out.println("在线直播授课");
    };

    private void ceatePPT(){
        System.out.println("课后资料上传");
    };

    private void postPreRsources(){
