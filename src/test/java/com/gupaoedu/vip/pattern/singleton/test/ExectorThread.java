...
import com.gupaoedu.vip.design.singleton.lazy.LazySimpleingletion;
import com.gupaoedu.vip.design.singleton.register.ContainerSingleton;

/**
 * <b>时间:</b> <i>2020-02-26 20:53</i> 修订原因:初始化创建.详细说明:<br>
 * <br>
...
public class ExectorThread implements Runnable{
    @Override
    public void run() {
        /*LazySimpleingletion instance = LazySimpleingletion.getInstance();
